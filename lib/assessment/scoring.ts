/**
 * Binary Scoring Calculator for Structured Assessments
 *
 * Handles yes/no question scoring, early termination logic,
 * and risk level calculation for the structured assessment format.
 */

import { AssessmentDomain, RiskLevel } from "@prisma/client";
import {
  EARLY_DETECTION_SCREENER,
  type AssessmentDomainConfig,
} from "./assessments";
