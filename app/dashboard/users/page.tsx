  ...
  return (
    <div>
      <div style={{ marginBottom: 28 }}>
        ...
        <h1 style={{ fontFamily: "var(--font-display, Georgia, serif)", fontSize: 32, fontWeight: 600, letterSpacing: "-0.02em", color: C.ink900, lineHeight: 1.1, margin: 0 }}>Users</h1>
        <p style={{ fontSize: 15, color: C.ink700, lineHeight: 1.55, margin: "10px 0 0" }}>Manage accounts, roles, and credit allocations.</p>
      </div>
      <UserManagementTab />
    </div>
  );
