...
export default function RegisterPage() {
  // Redirect all registration attempts to trial assessment
  redirect("/trial-assessment");
}

// Keep the old component for reference but don't export it
...
/**
 * Register page now redirects to trial assessment
 * No standalone registration allowed
 */
export default function RegisterPage() {
  // Redirect to trial assessment instead of showing registration form
  if (typeof window !== 'undefined') {
    window.location.href = '/trial-assessment';
  }
  return null;
}
