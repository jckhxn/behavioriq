...
- Follow-up protocols`,
  ...
  const sampleScores = [
    { domain: 'ANTISOCIAL', rawScore: 15, riskLevel: 'LOW', confidence: 0.85 },
    { domain: 'VIOLENCE', rawScore: 8, riskLevel: 'LOW', confidence: 0.92 },
    { domain: 'ATTENTION', rawScore: 45, riskLevel: 'MODERATE', confidence: 0.78 },
    { domain: 'EMOTIONAL', rawScore: 35, riskLevel: 'MODERATE', confidence: 0.81 },
    { domain: 'CONDUCT', rawScore: 12, riskLevel: 'LOW', confidence: 0.88 }
  ]
  ...
  const messages = [
    ...
    },
    {
      sessionId: chatSession.id,
      role: 'ASSISTANT',
      content: 'Based on the security guidelines, password requirements include: minimum 12 characters, include uppercase, lowercase, numbers, and symbols, change passwords every 90 days, and do not reuse last 5 passwords.',
